  ...
  return (
    <div className='prompt_card'>
      <div className='flex justify-between items-start gap-5 flex-col'>
        ...
        <div>
          <Link href={`/post/${post._id}`}><h1 style={{fontWeight:"700",padding:"5px"}}>{post.title?post.title.slice(0,50):post.prompt.slice(0,50)} ...</h1></Link>
        </div>

      </div>
      <p className='font-inter my-1 text-sm cursor-pointer'>{views} views . 4 months ago</p>
