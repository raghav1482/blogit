...
const MyProfile = ({params}) => {
  ...
  <Toaster/>
    ...
    desc="Dive into a world of insightful articles, engaging stories, and thought-provoking content across a variety of topics. Whether you're passionate about technology, lifestyle, personal development, or just curious about the latest trends, our blog offers something for everyone. Stay updated with our regular posts that aim to inform, inspire, and entertain. Join our community of readers and be a part of conversations that matter. Subscribe now and never miss out on the latest posts!"
